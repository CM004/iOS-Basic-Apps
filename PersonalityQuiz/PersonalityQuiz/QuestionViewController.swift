    ...
    var questions : [Question] = [
        Question(
            ...
            answers : [
                ...
                Answer(text: "Cookies", type : .dog),
                Answer(text: "Fish", type : .dolphin),
                Answer(text: "SugarCane", type : .elephant),
            ]
        ),
        Question(
            ...
            answers : [
                ...
                Answer(text: "Playing", type : .dog),
                Answer(text: "Swimming", type : .dolphin),
                Answer(text: "Bathing", type : .elephant),
            ]
        ),
        Question(
            ...
            answers : [
                ...
                Answer(text: "I barely notice them", type : .dolphin),
                Answer(text: "I love them", type : .elephant),
            ]
        )
    ]
    var questionIndex = 0
